    ...
    private TransacaoContaSemSaldoDTO mapToDTO(Transacao transacao) {
        return TransacaoContaSemSaldoDTO.builder()
                ...
                .contaOrigem(transacao.getContaOrigem() != null
                        ...
                        .numero(transacao.getContaOrigem().getNumero())
                        .tipo(transacao.getContaOrigem().getTipo())
                        .id(transacao.getContaOrigem().getId())
                        .cliente(transacao.getContaOrigem().getCliente())
                        .agencia(transacao.getContaOrigem().getAgencia())
                        .dataDeAtualizacao(transacao.getContaOrigem().getDataDeAtualizacao())
                        .dataDeCriacao(transacao.getContaOrigem().getDataDeCriacao())
                        .build()
                        : null)
