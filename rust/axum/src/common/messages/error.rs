...
impl ErrorMessages {
    ...
    pub const ACCOUNT_BAD_REQUEST_ORIGIN: &'static str = "Conta de origem não informada.";
    pub const ACCOUNT_BAD_REQUEST_TARGET: &'static str = "Conta de destino não informada.";
    ...
    pub const ADDRESS_NOT_FOUND: &'static str = "Endereço não encontrado.";
