...
export class AuthController extends BaseController implements IAuthController {
  ...
  async loginClients(req: Request, res: Response) {
    ...
    const transformedBody = transformer(LoginAuthDto, body);

    const result = await this._service.loginClients(transformedBody);
  ...
  async loginManagers(req: Request, res: Response) {
    ...
    const result = await this._service.loginManagers(transformedBody);
