...
interface IClientsService {
  findOne: (id: string) => Promise<Either<BaseError, ClientEntity>>;
  findByCPF: (cpf: string) => Promise<Either<BaseError, ClientEntity>>;
  create: (data: ICreateClientData) => Promise<Either<BaseError, ClientEntity>>;
}

export class ClientsService implements IClientsService {
  constructor(private _repository: ClientsRepository) {}

  async findByCPF(cpf: string): Promise<Either<BaseError, ClientEntity>> {
  ...
  async findOne(id: string): Promise<Either<BaseError, ClientEntity>> {
  ...
  ): Promise<Either<BaseError, ClientEntity>> {
